...
SalaR is based on Flask (http://flask.pocoo.org/) and SB Admin 2 (https://startbootstrap.com/template-overviews/sb-admin-2/) and DataTables (https://datatables.net/)on eric python IDE.
